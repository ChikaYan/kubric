...
obj.material = kb.PrincipledBSDFMaterial(color=kb.Color(r=1, g=0.030765511645494348, b=0.0, a=1.0), metallic=0., ior=1.25,
                roughness=0.7, specular=0.33)
obj.position = (0, 0, 1)
obj.velocity = (0.5, 0, -1)
scene += obj


# color = kb.Color(r=1, g=0.030765511645494348, b=0.0, a=1.0)
...
kb.file_io.multi_write_image(frames_dict['segmentation'], str(kb.as_path(f"output/{OBJNAME}/segmentation") / "{:05d}.png"), write_fn=kb.write_palette_png,
                    max_write_threads=16, palette=palette)
kb.file_io.multi_write_image(frames_dict['rgba'], str(kb.as_path(f"output/{OBJNAME}/rgba") / "{:05d}.png"), write_fn=kb.write_png,
