...
scene += kb.Cube(name="floor", scale=(5, 5, 0.1), position=(0, 0, -0.1), static=True, background=True)
...
cube = kb.Cube(scale=0.1, velocity=velocity, quaternion=[0.871342, 0.401984, -0.177436, 0.218378], position=(0, 0, 1), mass=1, restitution=1, material=material)
scene += cube
