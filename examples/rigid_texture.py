...
cube = kb.Cube(name='cube', scale=0.3, velocity=velocity, angular_velocity=[0,0,0], position=(0, 0, 1), mass=0.2, restitution=1, material=material, friction=1, segmentation_id=2)
...
# tex_node.inputs["Roughness"].default_value = 1
